...
/* package mysolve-0.2.0.0 */
#ifndef VERSION_mysolve
#define VERSION_mysolve "0.2.0.0"
#endif /* VERSION_mysolve */
#ifndef MIN_VERSION_mysolve
#define MIN_VERSION_mysolve(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  2 || \
  (major1) == 0 && (major2) == 2 && (minor) <= 0)
#endif /* MIN_VERSION_mysolve */
...
#define CURRENT_COMPONENT_ID "mysolve-0.2.0.0-inplace-mysolve"
